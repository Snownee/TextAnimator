...
public class CommonProxy implements ModInitializer {
        ...
        private static Style textanimator$copyVanillaStyle(Style style) {
                try {
        ...
        private static <T> T textanimator$getField(Field field, Style style) throws IllegalAccessException {
...
//				System.out.println(words);
        ...
        private static boolean textanimator$hasClosingTag(String text, int fromIndex, String effectName) {
        ...
        private static boolean textanimator$isMirrorClosingTag(String text, int start, int end, String effectName) {
